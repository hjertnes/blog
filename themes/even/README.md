...
In order to customize the favicon you need to place **all** the following files in the `static` folder at the root of your site, which will overwrite those files in the [`themes/even//`](https://github.com/olOwOlo/hugo-theme-even/tree/master/) folder.
